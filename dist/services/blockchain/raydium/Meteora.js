...
class MeteorClient {
    ...
    createTokenWithMetadata(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield (0, utils_1.sleep)(8000);
                if (SHOULD_REVOKE_AUTHORITY) {
                    const revokeTransaction = new web3_js_1.Transaction();
                    revokeTransaction.add((0, spl_token_1.createSetAuthorityInstruction)(new web3_js_1.PublicKey(mint.publicKey.toString()), this.wallet.publicKey, spl_token_1.AuthorityType.MintTokens, null));
                    // Add instruction to revoke freeze authority
                    revokeTransaction.add((0, spl_token_1.createSetAuthorityInstruction)(new web3_js_1.PublicKey(mint.publicKey.toString()), this.wallet.publicKey, spl_token_1.AuthorityType.FreezeAccount, null));
                    // Sign and send the transaction
                    const revokeAuthorityTxId = yield this.signAndBroadcastTx(revokeTransaction);
    ...
    createPool(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const configs = yield this.cpAmm.getAllConfigs();
                if (configs.length === 0) {
                    throw new Error("No configuration accounts found");
                }
                const configAccount = configs[0].publicKey;
                const configState = yield this.cpAmm.fetchConfigState(configAccount);
                ...
                const tokenAInfo = yield this.connection.getParsedAccountInfo(tokenAMint);
                const tokenBInfo = yield this.connection.getParsedAccountInfo(tokenBMint);
                // @ts-ignore - Extract decimals from parsed info
                const tokenADecimals = ((_a = tokenAInfo.value) === null || _a === void 0 ? void 0 : _a.data.parsed.info.decimals) || 9;
                // @ts-ignore - Extract decimals from parsed info
                const tokenBDecimals = ((_b = tokenBInfo.value) === null || _b === void 0 ? void 0 : _b.data.parsed.info.decimals) || 9;
                ...
                const createPoolTx = yield this.cpAmm.createPool({
                    payer: this.wallet.publicKey,
                    creator: this.wallet.publicKey,
                ...
                const txId = yield this.signAndBroadcastTx(createPoolTx, positionNftKeypair);
    ...
    addLiquidity(poolId, positionId, tokenAAmount, tokenBAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Add liquidity
                const addLiquidityTx = yield this.cpAmm.addLiquidity({
                ...
                const txId = yield this.signAndBroadcastTx(tx);
     ...
     * @param positionId - ID of the position
     */
    removeAllLiquidity(poolId, positionId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const pool = new web3_js_1.PublicKey(poolId);
                ...
                const removeAllLiquidityTx = yield this.cpAmm.removeAllLiquidity({
                    owner: this.wallet.publicKey,
                    pool,
                    position,
     ...
     * @param positionId - ID of the position
     */
    closePosition(poolId, positionId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const positionNft = new web3_js_1.PublicKey(positionId);
                const position = (0, cp_amm_sdk_1.derivePositionAddress)(positionNft);
                ...
                // }
                const closePositionTx = yield this.cpAmm.closePosition({
                    owner: this.wallet.publicKey,
     ...
     */
    removeAllLiquidityAndClosePosition(poolId, positionId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const pool = new web3_js_1.PublicKey(poolId);
                const positionNft = new web3_js_1.PublicKey(positionId);
                ...
                const poolState = yield this.cpAmm.fetchPoolState(pool);
                const positionState = yield this.cpAmm.fetchPositionState(position);
                ...
                if (totalLiquidity.isZero()) {
                    ...
                    const txId = yield this.signAndBroadcastTx(closePositionTx);
                    console.log("Position closed", { txId });
                    return { txId };
                }
                ...
                const tx = yield this.cpAmm.removeAllLiquidityAndClosePosition({
                    owner: this.wallet.publicKey,
                    position,
                    positionNftAccount,
                    positionState,
    ...
    signAndBroadcastTx(tx, otherSigner) {
        return __awaiter(this, void 0, void 0, function* () {
            const blockhash = yield (0, utils_1.getLatestBlockhash)();
            ...
            const txId = yield this.connection.sendRawTransaction(tx.serialize(), {
                skipPreflight: false,
